...
class LogisticPolynomialRegression(Regression):
    ...
    def train(
        ...
        epochs:         int,
        learning_rate:  float
    ) -> Tuple[Tuple[float, float, float], Tuple[int, Union[int, float]]]:
        normalization_result: Tuple[List[Tuple[int, float]], Tuple[int, Union[int, float]]] = LogisticPolynomialRegression._Regression__normalize(data_list)
