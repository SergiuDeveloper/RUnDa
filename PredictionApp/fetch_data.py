...
def write_csv_data_to_file_system(
    resources_list: List[Dict[str, Any]]
) -> None:
    ...
    for resource in resources_list:
        ...
        try:
            with open(f'Data/{category_name}/{year}/{month}/Data.csv', 'w', encoding = 'latin-1') as csv_file:
                csv_file.write(csv_online_content.text)
        except:
            with open(f'Data/{category_name}/{year}/{month}/Data.csv', 'wb') as csv_file:
                csv_file.write(csv_online_content.content)

            xls_to_csv(f'Data/{category_name}/{year}/{month}/Data.csv', f'Data/{category_name}/{year}/{month}/Data2.csv')
...
resources_list: List[Dict[str, Any]] = get_resources_list()
write_csv_data_to_file_system(resources_list)